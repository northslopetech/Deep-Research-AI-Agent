...
- `FOUNDRY_BASE_URL` - Foundry API base URL
...
| File | Purpose |
|------|---------|
| `src/lib/foundry-provider.ts` | Initialize `@northslopetech/foundry-ai-sdk` |
| `src/lib/foundry-client.ts` | Fetch wrapper for Foundry function calls |
| `src/app/api/deep-research/foundry-tools.ts` | Web search + Ontology search tools |
